...
def main() -> None:
    ...
    ckpt = args.checkpoint or run_path / "dqn_scoring_enhanced_model.pth"
    stats_path = run_path / "dqn_scoring_enhanced_training_stats.json"

    print(f"\nTraining Enhanced Path-Scoring DQN on {run_path}")
