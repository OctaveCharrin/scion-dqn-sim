#!/usr/bin/env python3
"""Intent alignment for the Conditional-FiLM checkpoint (Chapter 6, Figure 6.1).
...
from src.pipeline.chapter6_eval import MAX_EVAL_PAIRS, run_intent_alignment
...
def main() -> None:
    ...
    print(f"Intent alignment (Conditional-FiLM) on {run_path}")
